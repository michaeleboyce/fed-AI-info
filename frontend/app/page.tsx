      ...
      <header className="bg-gov-navy-900 text-white py-6 border-b-4 border-gov-navy-700">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-start">
            <div>
              <h1 className="text-3xl font-bold">FedRAMP Marketplace Browser</h1>
              <p className="text-gov-navy-100 mt-2">
                Browse, search, and filter {products.length} FedRAMP authorized cloud services
              </p>
            </div>
            <a
              href="/ai-services"
              className="bg-gov-navy-700 hover:bg-gov-navy-600 text-white px-4 py-2 rounded-md text-sm font-semibold transition-colors flex items-center gap-2 border border-gov-navy-600"
            >
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-gov-navy-900 mb-2">AI Services in FedRAMP</h2>
              <p className="text-gov-slate-600">
                Explore AI, Generative AI, and LLM services that are FedRAMP authorized
              </p>
            </div>
            <div className="text-right">
              <div className="text-sm text-gov-slate-500 mb-1">Analyzed by Claude Haiku 4.5</div>
